...
void ACoyoteTimeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACoyoteTimeCharacter::Look);
	}
	else
	{
...
void ACoyoteTimeCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACoyoteTimeCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
